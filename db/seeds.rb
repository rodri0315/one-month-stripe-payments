...
growth_hacking = Product.create(title: "Growth Hacking", 
	...
	price: "4.99", sku: "GROHACK1", download_url: "https://s3.amazonaws.com/one-month-jlr-stripe/Optimization+n+local+extrema.pdf", details: "You'll get one video", 
...
growth_hacking = Product.create(title: "Growth Hacking", subtitle: "Crash Course",
	author: "Mattan Griffel", price: "4.99", sku: "GROHACK1", details: "You'll get one  video",
	download_url: "https://s3.amazonaws.com/one-month-jlr-stripe/Optimization+n+local+extrema.pdf",
	description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
