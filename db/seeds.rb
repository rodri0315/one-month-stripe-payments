...
growth_hacking = Product.create(tittle: "Growth Hacking",
	subtitle: "Crash Course", author: "Mattan Griffel", 
	length: "30 minutes", author_image_name: "teacher-image.jpg", 
	price: "4.99", sku: "GROHACK1", download_url: "https://s3.amazonaws.com/one-month-jlr-stripe/Optimization+n+local+extrema.pdf", 
